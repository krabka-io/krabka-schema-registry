...
/// One entry of `GET /schemas/ids/{id}/versions`.
///
/// The endpoint answers with every subject a schema id is registered under,
/// and the version it holds there. A caller that has to decide whether an id
/// belongs to a topic reads this rather than the schema text.
